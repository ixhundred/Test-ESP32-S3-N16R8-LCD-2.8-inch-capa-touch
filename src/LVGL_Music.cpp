...
lv_obj_t * create_ctrl_box(lv_obj_t * parent)
{
  ...
  static const lv_coord_t grid_col[] = {LV_GRID_FR(1), LV_GRID_FR(3), LV_GRID_FR(5), LV_GRID_FR(5), LV_GRID_FR(5), LV_GRID_FR(3), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
  ...
  icon2 = lv_img_create(cont);                                                                    
  lv_img_set_src(icon2, &img_lv_demo_music_btn_loop);                                              
