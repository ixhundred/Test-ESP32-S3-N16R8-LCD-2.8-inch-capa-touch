...
static void Onboard_create(lv_obj_t * parent)
{
  ...
  if(disp_size == DISP_LARGE) {
    ...
    lv_obj_set_grid_cell(panel1_title, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_CENTER, 0, 1);
    ...
    lv_obj_set_grid_cell(angle_label, LV_GRID_ALIGN_START, 0, 1, LV_GRID_ALIGN_START, 6, 1);
    lv_obj_set_grid_cell(Board_angle, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 7, 1);
    lv_obj_set_grid_cell(Time_label, LV_GRID_ALIGN_START, 0, 1, LV_GRID_ALIGN_START, 8, 1);
    lv_obj_set_grid_cell(RTC_Time, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_ALIGN_CENTER, 9, 1);
    lv_obj_set_grid_cell(Wireless_label, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_START, 10, 1);
    lv_obj_set_grid_cell(Wireless_Scan, LV_GRID_ALIGN_STRETCH, 0, 2, LV_GRID_ALIGN_CENTER, 11, 1);
  }
  else if(disp_size == DISP_MEDIUM) {
    static lv_coord_t grid_main_col_dsc[] = {LV_GRID_FR(1), LV_GRID_FR(1), LV_GRID_TEMPLATE_LAST};
    static lv_coord_t grid_main_row_dsc[] = {LV_GRID_CONTENT, LV_GRID_CONTENT, LV_GRID_TEMPLATE_LAST};
    ...
    lv_obj_set_grid_dsc_array(panel1, grid_2_col_dsc, grid_2_row_dsc);
    lv_obj_set_grid_cell(panel1_title, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_CENTER, 0, 1);
    lv_obj_set_grid_cell(SD_label, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_START, 2, 1);
    lv_obj_set_grid_cell(SD_Size, LV_GRID_ALIGN_STRETCH, 0, 2, LV_GRID_ALIGN_CENTER, 3, 1);
    lv_obj_set_grid_cell(Flash_label, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_START, 4, 1);
    lv_obj_set_grid_cell(FlashSize, LV_GRID_ALIGN_STRETCH, 0, 2, LV_GRID_ALIGN_CENTER, 5, 1);
    lv_obj_set_grid_cell(angle_label, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_START, 6, 1);
    lv_obj_set_grid_cell(Board_angle, LV_GRID_ALIGN_STRETCH, 0, 2, LV_GRID_ALIGN_CENTER, 7, 1);
    lv_obj_set_grid_cell(Time_label, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_START, 8, 1);
    lv_obj_set_grid_cell(RTC_Time, LV_GRID_ALIGN_STRETCH, 0, 2, LV_GRID_ALIGN_CENTER, 9, 1);
    lv_obj_set_grid_cell(Wireless_label, LV_GRID_ALIGN_START, 0, 2, LV_GRID_ALIGN_START, 10, 1);
    lv_obj_set_grid_cell(Wireless_Scan, LV_GRID_ALIGN_STRETCH, 0, 2, LV_GRID_ALIGN_CENTER, 11, 1);
  }
